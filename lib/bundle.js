...
/* harmony import */ var _sound__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sound */ "./lib/sound.js");
...
class Game {
  constructor(ctx, ctx2){
    ...
    this.player = new _player__WEBPACK_IMPORTED_MODULE_2__["default"](this.ctx);
  ...
  renderLife() {
    ...
    this.ctx2.fillText("score: ", 530, 52)
    this.ctx2.fillText(score, 720, 55);
